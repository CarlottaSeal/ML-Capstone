...
if __name__ == '__main__':
    ...
    parser.add_argument('--features', type=str, default='MP',
                        help='forecasting task, options:[M, S, MS, MP]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate, MP:multivariate predict partial multivariate variate')
